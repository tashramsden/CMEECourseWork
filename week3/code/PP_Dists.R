...
stats <- ecol_data %>% 
    ...
    summarise(pred_mean = mean(log10(Predator.mass)),
              ...
              prey_mean = mean(log10(Prey.mass)),
              prey_median = median(log10(Prey.mass)),
              ratio_mean = mean(log10(Prey.mass/Predator.mass)),
              ratio_median = median(log10(Prey.mass/Predator.mass)))
